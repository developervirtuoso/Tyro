...
<div class="container">
    ...
    <%   String ip = request.getHeader("X-Forwarded-For");  
        ...
        %>
                        ...
                        <form role="form" action="UserSignIn" method="post"  name="frm">
                            <fieldset>
                            
                                <div class="form-group">
                 <input type="hidden" id="publicip" class="form-control" placeholder="publicip" name="publicip" >
          <input type="text" id="email" class="form-control" placeholder="User Name" name="username" autofocus>
        </div>
